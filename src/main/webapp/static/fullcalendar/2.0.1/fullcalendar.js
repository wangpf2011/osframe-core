...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) { // date assumed to have stripped time
		...
		if (showNumbers) {
			...
			var cnMonth = CnMonthofDate(mydate);//农历月 
		    var cnDay = CnDayofDate(mydate);//农历日 
		    var solar = SolarTerm(mydate);//农历节气 
		    ...
		    html += "<div class='fc-day-number'><span class='solarday'>"+ cnDay+"</span> <span class='holiday'>"+holiday+"</span>" + mydate.getDate() + "</div>"; 
		}
