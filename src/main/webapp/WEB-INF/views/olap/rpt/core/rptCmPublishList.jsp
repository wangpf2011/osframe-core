...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/rpt/core/rptCm/publishList">报表模板发布列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="rptCm" action="${ctx}/rpt/core/rptCm/publishList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="rptCm">
			<tr>
				...
				<c:if test="${rptCm.flowStatus=='2'}">
    				<a href="${ctx}/rpt/core/rptCm/publish?id=${rptCm.id}">发布</a>
    			</c:if>
