...
<meta name="author" content=""/><meta http-equiv="X-UA-Compatible" content="IE=8,IE=9,IE=10" />
<!-- 若页面需默认用极速核，增加标签 http://se.360.cn/v6/help/meta.html-->
...
<script src="${ctxStatic}/jquery/jquery.json.min.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/jess.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/jess.min.js" type="text/javascript"></script>
