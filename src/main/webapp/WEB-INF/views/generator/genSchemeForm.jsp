...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/generator/genScheme/">生成方案列表</a></li>
		<li class="active"><a href="${ctx}/generator/genScheme/form?id=${genScheme.id}">生成方案<shiro:hasPermission name="gen:genScheme:edit">${not empty genScheme.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="gen:genScheme:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/generator/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<div class="control-group">
			<label class="control-label">生成目录:</label>
			<div class="controls">
				<form:input path="location" htmlEscape="false" maxlength="500" class="required input-xlarge"/>
				<span class="help-inline">E:/workspaceSSH/jess/</span>
			</div>
		</div>
		<!--  
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.lnint.jess.modules</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
		 ...
		 <!-- 
		<div class="control-group">
			<label class="control-label">场景名:</label>
			<div class="controls">
				<form:input path="genScene.id" htmlEscape="false" maxlength="500" class="required input-xlarge"/>
				<span class="help-inline"></span>
			</div>
		</div>
		-->
		<div class="control-group">
			<label class="control-label">场景名:</label>
			<div class="controls">
				<form:select path="genScene.id" class="required input-xlarge">
					<form:options items="${sceneList}" itemLabel="comments" itemValue="id" htmlEscape="false"/>
				</form:select>
				<span class="help-inline"></span>
			</div>
		</div>
		...
		<div class="form-actions">
				...
				<input id="btnSubmit" class="btn btn-success" type="submit" value="保存并生成代码" onclick="$('#flag').val('1');"/>&nbsp;
