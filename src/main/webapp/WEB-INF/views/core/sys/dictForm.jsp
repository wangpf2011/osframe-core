	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议数字,如:1，2...</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">标签名称,如:删除</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">所属字典（英文）,如:ln_del_flag</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">所属字典名称:</label>
			<div class="controls">
				<form:input path="description" htmlEscape="false" maxlength="50" class="required"/>
				<span class="help-inline">所属字典名称,如:内容状态</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">排序号码,1-999,值越小越靠前</span>
			</div>
		</div>
