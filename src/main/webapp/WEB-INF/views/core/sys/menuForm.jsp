...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="isShow" items="${fns:getDictList('sys_show_hide')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">同步到工作流:</label>
			<div class="controls">
				<form:radiobuttons path="isActiviti" items="${fns:getDictList('sys_yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">权限标识:</label>
			<div class="controls">
				<form:textarea path="permission" htmlEscape="false" rows="4" maxlength="2000" class="input-xxlarge"/>
			</div>
