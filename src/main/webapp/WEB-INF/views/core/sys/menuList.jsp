		...
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			...
			<c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1' ? menu.parent.id : '0'}">
					...
					<td><a href="javascript:" onclick="$('#c_${menu.id}').toggle()">${fns:abbr(fns:replaceHtml(menu.permission),40)}</a></td>
				...
				<tr id="c_${menu.id}" style="background:#fdfdfd;display:none;"><td colspan="6">${fns:replaceHtml(menu.permission)}</td></tr>
			</c:forEach>
		</table>
