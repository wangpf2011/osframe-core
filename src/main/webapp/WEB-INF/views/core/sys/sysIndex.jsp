...
<body>
<!-- banner -->
<div id="top" style="background-color:#2E90FB">
	<img src="${ctxStatic}/resource/img/tile_1000x60.png"  height="60"/>
</div>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown">
						...
						<ul class="dropdown-menu">
							<c:forEach items="${fns:getDictList('sys_theme')}" var="dict"><li><a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href">${dict.label}</a></li></c:forEach>
