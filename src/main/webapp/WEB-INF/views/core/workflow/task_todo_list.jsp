			...
			<c:forEach items="${list}" var="act">
				...
				<tr>
					...
					<td>
						...
						<a target="_blank" href="${pageContext.request.contextPath}/modeler/diagram-viewer?processDefinitionId=${task.processDefinitionId}&processInstanceId=${task.processInstanceId}">跟踪1</a>
						<a target="_blank" href="${ctx}/workflow/task/trace/photo/${task.processDefinitionId}/${task.executionId}">跟踪2</a><%--  
