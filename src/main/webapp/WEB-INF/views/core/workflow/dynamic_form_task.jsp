...
<body>
	...
	<form:form id="inputForm" modelAttribute="form" action="${ctx}/workflow/form/dynamic/taskcomplete/${taskId}" method="post" class="form-horizontal">
