...
public class Reflections {
	...
	/**
	 * <P>直接读取对象属性值, 无视private/protected修饰符, 不经过getter函数</P>
	 */
	...
	/**
	 * <P>直接调用对象方法, 无视private/protected修饰符.</br>
	...
	/**
	 * <P>改变private/protected的方法为public，尽量不调用实际改动的语句，避免JDK的SecurityManager抱怨。</P>
	 */
	...
	/**
	 * <P>改变private/protected的成员变量为public，尽量不调用实际改动的语句，避免JDK的SecurityManager抱怨。</P>
	 */
	...
	/**
	 * <P>通过反射, 获得Class定义中声明的泛型参数的类型, 注意泛型必须定义在父类处</br>
	...
	/**
	 * <P>通过反射, 获得Class定义中声明的父类的泛型参数的类型.</br>
	 * 如无法找到, 返回Object.class.</br>
	 * </br>
