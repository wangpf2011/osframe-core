...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static boolean copyFileCover(String srcFileName,
		...
		try {
			...
			// BufferedInputStream 可以考虑使用这个类包裹FileInputStream
	...
	/**
	 * <P>解压缩ZIP文件，将ZIP文件里的内容解压到descFileName目录下</P>
...
//						.println("添加文件 " + file.getAbsolutePath() + " 到zip文件中!");
	...
	/**
	 * <P>获取待压缩文件在ZIP文件中entry的名字，即相对于跟目录的相对路径名</P>
	 * @param dirPath 目录名
	 * @param file entry文件名
	 * @return
	 */
	 ...
	 * add by weisu
	 */
    public static List<String> readLines(MultipartFile file, String encoding) throws IOException {
        InputStream in = null;
        try {
	 ...
	 * 读取文件对象，获得对象字节数组
	 */
    public byte[] getByteContent(File file) throws IOException {  
